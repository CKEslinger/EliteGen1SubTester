...
'  File: CBW.BAS
'
'  (c) Copyright 1996 - 1999 by Computer Boards
'      All Rights Reserved
'
...
Global Const CURRENTREVNUM = 5.1
' Error Codes
...
Global Const AMBIGSENSORTYPE = 114      ' more than one sensor type defined for EXP-GP
...
Global Const MA2to10 = 201
Global Const MA1TO5 = 202
Global Const MAPT5TO2PT5 = 203
